...
const AcceptReschedulePopup = ({handleFilter, rescheduleBooking}) => {
  ...
  return (
    <Animated.View
      ...
      <View style={styles.roundCard}>
        <Text style={styles.sampleText}>Are you sure you want to Accept?</Text>
...
export default AcceptReschedulePopup;
