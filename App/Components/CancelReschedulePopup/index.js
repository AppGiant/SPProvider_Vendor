...
const CancelReschedulePopup = ({handleFilter, rescheduleBooking}) => {
  ...
  return (
    <Animated.View
      ...
      <View style={styles.roundCard}>
        <Text style={styles.sampleText}>Are you sure you want to Cancel?</Text>
...
export default CancelReschedulePopup;
